...
describe('Date Selector Class Tests', () => {
    ...
    test('Build', () => {
        ...
        jest.spyOn(Renderer.TimeSelector, 'Render').mockImplementation(() => {return '';});
        jest.spyOn(DateUtils, 'GetDisplayDate').mockImplementation(() => {return '';});
    ...
    test('Set Position', () => {
        ...
        jest.spyOn(elm,'closest').mockImplementation(() => {return container;});

        const elmgbcr = jest.spyOn(elm, 'getBoundingClientRect').mockReturnValue({top:0, left:0, right: 0, bottom:0, y: 0, x: 0, width: 0, height:0, toJSON: () => {}});
        jest.spyOn(container, 'getBoundingClientRect').mockReturnValue({top:0, left:0, right: 0, bottom:0, y: 0, x: 0, width: 0, height:0, toJSON: () => {}});
    ...
    test('Update', () => {
        jest.spyOn(ds, 'build').mockImplementation(() => {return '';});
    ...
    test('Activate Listeners', () => {
        ...
        const qs = jest.spyOn(document, 'querySelector').mockImplementation(() => {return html;});
        const htmlQs = jest.spyOn(html, 'querySelector').mockImplementation(() => {return null;});
