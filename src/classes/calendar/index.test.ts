...
describe('Calendar Class Tests', () => {
    ...
    beforeEach(async () => {
        ...
        jest.spyOn(CalManager, 'isActiveCalendar').mockImplementation(() => {return true;});
    ...
    test('Change Date Time', () => {
        ...
        expect(tCal.changeDateTime({year: 1, month: 1, day : 1, hour: 1, minute: 1, seconds: 1}, {updateApp: false, save: false, sync: false})).toBe(true);
        ...
        jest.spyOn(CalManager,'syncWithAllCalendars', 'get').mockImplementation(() => {return true;});
    ...
    test('Set From Time', () => {
        ...
        jest.spyOn(tCal, 'secondsToDate').mockImplementation(() => {return {year: 0, month: 0, day: 0, hour: 0, minute: 0, seconds: 0};});
        ...
        jest.spyOn(tCal.timeKeeper, 'getStatus').mockImplementation(() => {return TimeKeeperStatus.Started;});
        tCal.setFromTime(1, 1);
