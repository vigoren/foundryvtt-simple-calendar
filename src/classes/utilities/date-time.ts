...
export function FormatDateTime(date: SimpleCalendar.DateTime, mask: string, calendar: Calendar, inputs: {year?: boolean, month?: boolean} = {}){
    ...
    const formatFlags: Record<string, (dateObj: SimpleCalendar.DateTime) => string> = {
        "D": (dateObj: SimpleCalendar.DateTime) => String(calendar.months[dateObj.month]?.days[dateObj.day]?.numericRepresentation || 0),
        "DD": (dateObj: SimpleCalendar.DateTime) => PadNumber(calendar.months[dateObj.month]?.days[dateObj.day]?.numericRepresentation || 0),
        "DO": (dateObj: SimpleCalendar.DateTime) => `${String(calendar.months[dateObj.month]?.days[dateObj.day]?.numericRepresentation || 0)}${ordinalSuffix(calendar.months[dateObj.month]?.days[dateObj.day]?.numericRepresentation | 0)}`,
        "d": (dateObj: SimpleCalendar.DateTime) => String(calendar.weekdays[calendar.dayOfTheWeek(dateObj.year, dateObj.month, dateObj.day)]?.numericRepresentation || 0),
        "dd": (dateObj: SimpleCalendar.DateTime) => PadNumber(calendar.weekdays[calendar.dayOfTheWeek(dateObj.year, dateObj.month, dateObj.day)]?.numericRepresentation || 0),
        ...
        "M": (dateObj: SimpleCalendar.DateTime) => String(calendar.months[dateObj.month]?.numericRepresentation || 0),
        "MM": (dateObj: SimpleCalendar.DateTime) => PadNumber(calendar.months[dateObj.month]?.numericRepresentation || 0),
