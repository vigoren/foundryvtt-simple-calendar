...
describe('Migration App Class Tests', () => {
    ...
    test('Run Calendar Migration', () => {
        const rcm = jest.spyOn(V1ToV2, 'runCalendarMigration').mockImplementation(() => {return null;});
        const rgcm = jest.spyOn(V1ToV2, 'runGlobalConfigurationMigration').mockImplementation(() => {return false;});
    ...
    test('Run Note Migration', async () => {
        jest.spyOn(V1ToV2, 'runNoteMigration').mockImplementation(async () => {return false;});
        ...
        jest.spyOn(V1ToV2, 'runNoteMigration').mockImplementation(async () => {return true;});
