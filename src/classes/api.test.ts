...
describe('API Class Tests', () => {
    ...
    test('Timestamp to Date', () => {
        ...
        year.gameSystem = GameSystems.PF2E;
        year.generalSettings.pf2eSync = true;
        expect(API.timestampToDate(3600)).toStrictEqual({year: -1, month: 1, day: 29, dayOfTheWeek: 0, hour: 1, minute: 0, second: 0, monthName: "M2", yearName: "", yearZero: 0, weekdays: ["W1"], currentSeason: season, showWeekdayHeadings: true, yearPostfix: '', yearPrefix: '', dayOffset: 0, dayDisplay: '30', "display": {"day": "30", "daySuffix": "", "month": "2", "monthName": "M2", "weekday": "W1", "year": "-1", "yearName": "", "yearPostfix": "", "yearPrefix": "", time:"00:00:00"}});
        expect(API.timestampToDate(5184000)).toStrictEqual({year: 0, month: 1, day: 29, dayOfTheWeek: 0, hour: 0, minute: 0, second: 0, monthName: "M2", yearName: "", yearZero: 0, weekdays: ["W1"], currentSeason: season, showWeekdayHeadings: true, yearPostfix: '', yearPrefix: '', dayOffset: 0, dayDisplay: '30', "display": {"day": "30", "daySuffix": "", "month": "2", "monthName": "M2", "weekday": "W1", "year": "0", "yearName": "", "yearPostfix": "", "yearPrefix": "", time:"00:00:00"}});
