...
describe('API Class Tests', () => {
    ...
    test('Choose Random Date', () => {
        ...
        expect(API.chooseRandomDate({}, {}, '')).toBeDefined();
        expect(API.chooseRandomDate({year: 2000, month: 1, day: 0, hour: 0, minute: 0, seconds: 0},{year: 2021, month: 2, day: 1, hour: 12, minute:20, seconds:30})).toBeDefined();
        expect(API.chooseRandomDate({year: 2000, month: 1, day: 3, hour: 0, minute: 0, seconds: 0},{year: 2000, month: 1, day: 3, hour: 0, minute: 0, seconds: 0})).toStrictEqual({year: 2000, month: 1, day: 3, hour: 0, minute: 0, seconds: 0});
        expect(API.chooseRandomDate({year: 2000, month: -1, day: -3, hour: 0, minute: 0, seconds: 0},{year: 2000, month: -1, day: -3, hour: 0, minute: 0, seconds: 0})).toStrictEqual({year: 2000, month: 11, day: 30, hour: 0, minute: 0, seconds: 0});
    });
    ...
    test('Date to Timestamp', () => {
        ...
        jest.spyOn(DateUtilities, 'DateToTimestamp').mockImplementation(() => {return 1;});
    ...
    test('Format Date Time', () => {
        ...
        expect(API.formatDateTime({year: 2021, month: 11, day: 24, hour: 10, minute: 20, seconds: 30})).toStrictEqual({date: 'December 25, 2021', time: '10:20:30'});
    ...
    test('Get Notes', () => {
        ...
        jest.spyOn(NManager, 'getNotes').mockImplementation(() => {return [new NoteStub('asd')]});
        expect(API.getNotes('').length).toEqual(1);
    });

    test('Get Notes For Day', () => {
        expect(API.getNotesForDay).toThrowError();
        jest.spyOn(NManager, 'getNotesForDay').mockImplementation(() => {return [new NoteStub('asd')]});
    ...
    test('Seconds To Interval', () => {
        ...
        jest.spyOn(tCal,'secondsToInterval').mockImplementation(() => {return {};});
    ...
    test('Timestamp', () => {
        ...
        jest.spyOn(tCal,'toSeconds').mockImplementation(() => {return 0;});
